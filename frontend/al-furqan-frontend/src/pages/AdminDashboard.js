...
const AdminDashboard = () => {
  ...
  const loadUsers = () => {
    fetchWithAuth("https://final-project-al-furqan-rj1r.onrender.com/api/users")
      .then(async (res) => {
  ...
  const handleAddUser = () => {
    ...
    fetchWithAuth("https://final-project-al-furqan-rj1r.onrender.com/api/users/create", {
      method: "POST",
  ...
  const handleDeleteUser = (id, username) => {
    ...
    fetchWithAuth(`https://final-project-al-furqan-rj1r.onrender.com/api/users/dashboard/${id}`, { method: "DELETE" })
      .then(async (res) => {
        const json = await res.json();
