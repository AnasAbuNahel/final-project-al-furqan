...
const Settings = () => {
  ...
  const fetchWithAuth = (url, options = {}) => {
    ...
    const loadAdmins = () => {
    fetchWithAuth('https://final-project-al-furqan-rj1r.onrender.com/api/supervisors')
      .then(async (res) => {
  ...
  const handleRemoveAdmin = () => {
    ...
    fetchWithAuth(`https://final-project-al-furqan-rj1r.onrender.com/api/users/${id}`, {
      method: 'DELETE',
    })
      .then(async (res) => {
