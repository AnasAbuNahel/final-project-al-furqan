...
const Settings = () => {
  ...
  const fetchWithAuth = (url, options = {}) => {
    ...
    const loadAdmins = () => {
    fetchWithAuth('https://final-project-al-furqan-2389.onrender.com/api/supervisors')
      .then(async (res) => {
  ...
  const handleRemoveAdmin = () => {
    ...
    fetchWithAuth(`https://final-project-al-furqan-2389.onrender.com/api/users/${id}`, {
      method: 'DELETE',
    })
      .then(async (res) => {
