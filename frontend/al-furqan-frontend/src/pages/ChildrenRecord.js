...
useEffect(() => {
  ...
  axios
    .get("https://final-project-al-furqan-rj1r.onrender.com/api/children", {
...
const handleImportExcel = async (event) => {
  ...
  reader.onload = async (e) => {
    try {
      ...
      for (const row of jsonData) {
        ...
        try {
          await axios.post(
            "https://final-project-al-furqan-rj1r.onrender.com/api/children",
            payload,
            { headers: { Authorization: `Bearer ${token}` } }
          );
      ...
      const res = await axios.get("https://final-project-al-furqan-rj1r.onrender.com/api/children", {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleSaveEdit = () => {
    ...
    axios
      .put(`https://final-project-al-furqan-rj1r.onrender.com/api/children/${currentChild.id}`, updatedChild, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(() => {
...
const handleDelete = (id) => {
  ...
  if (window.confirm("هل أنت متأكد من أنك تريد حذف هذا السجل؟")) {
    axios
      .delete(`https://final-project-al-furqan-rj1r.onrender.com/api/children/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(() => {
      ...
      {Object.entries(activeFilters).map(([key, cond]) =>
        ...
        <button
          onClick={() => {
            ...
            axios
              .put(`https://final-project-al-furqan-rj1r.onrender.com/api/children/${helpChild.id}`, updatedChild, {
                headers: { Authorization: `Bearer ${token}` },
              })
              .then(() => {
