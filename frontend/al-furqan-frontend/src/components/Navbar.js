  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      try {
        ...
        const res = await fetch("https://final-project-al-furqan-rj1r.onrender.com/api/notifications", {
        ...
        if (location.pathname === '/notifications') {
          ...
          await fetch("https://final-project-al-furqan-rj1r.onrender.com/api/notifications/mark-read", { method: 'POST', headers: { Authorization: `Bearer ${token}` } });
        } else {
